...
namespace RuiNote.Views
{
    ...
    public sealed partial class NoteEditPage : Page
    {
        ...
        protected override void OnNavigatedTo(NavigationEventArgs e)
        {
            ...
            Messenger.Default.Send(new NotificationMessage("UpdateNavigatedNote"));
        }
        ...
        private void HardwareButtons_BackPressed(object sender, Windows.Phone.UI.Input.BackPressedEventArgs e)
        {
            ...
            e.Handled = true;
            if (pageName == "RuiNote.Views.NoteEditPage")
            {
                System.Diagnostics.Debug.WriteLine("now we can save the page!");
                Messenger.Default.Send(new NotificationMessage("NoteEditPageBackButtonPressed"));
            }
